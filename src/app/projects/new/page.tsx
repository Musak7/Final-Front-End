  ...
  const handleAnalyze = async () => {
    ...
    try {
      const res = await fetch("/api/ai/analyze", {
        ...
        body: JSON.stringify({ text, projectName: name }),
      });
      ...
      const { projectId, epics } = await res.json();
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Paste your raw requirements text (meeting notes, feature descriptions,
          etc.) and let AI generate structured Epics and User Stories.
        </p>
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-xs font-medium ${
                  wordCount >= 200 ? "text-green-600" : "text-gray-400"
                }`}
              >
          ...
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-gray-100">
            <div
              className={`h-full rounded-full transition-all duration-300 ${
                wordCount >= 200 ? "bg-green-500" : "bg-blue-500"
              }`}
